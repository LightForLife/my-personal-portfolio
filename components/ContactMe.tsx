...
function ContactMe({}: Props) {
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-8 xl:space-y-10">
        ...
        <div className="space-y-8 xl:space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-2xl">+380683434810</p>
          </div>{" "}
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#F7AB0A] h7 w-7 animate-pulse" />
            <p className="text-2xl">arturlvchnk@gmail.com</p>
          </div>{" "}
          <div className="flex items-center space-x-5 justify-center">
            <MapPinIcon className="text-[#F7AB0A] h7 w-7 animate-pulse" />
            <p className="text-2xl">123 Developer Lane, Kyiv</p>
          </div>
        </div>
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="bg-[#F7AB0A] py-5 px-10 rounded-md text-black font-bold text-lg hover:bg-[#F7AB0A]/90 duration-200"
          >
            Submit
          </button>
        </form>
